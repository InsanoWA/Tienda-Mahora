const PieDePagina = () =>{
    return (
        <div className="bg-white w-full p-8">
          ...
          <div class="w-full bg-white rounded-lg p-4 flex flex-col gap-4 items-center justify-center md:justify-between">
          ...
          <div>
            <h1>Direccion</h1>
            <p>Sector 2 Grupo 10 Manzana G Lote 18 Villa el Salvador 
            <br/>
  ...
  <div className="md:col-span-10 lg:col-span-3 items-left">
      ...
      <a href="#"
        className="xl:py-1 xl:px-2 rounded-lg hover:bg-gray-100 transition-colors" >
     <div>
         <h3 className=" text-black">Horario de atencion</h3>
         <div>
          <table>
            <tbody>
              <tr>
    ...
    <div className="flex flex-col xl:flex-row gap-4 items-center justify-between">
      <p className="text-gray-800 text-center md:text-left">
        &copy; 2023
        <span className="text-gray-900 font-bold">Mahora</span> Todos
